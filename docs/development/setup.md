...
file count, screenshot counts, and reference-import missing/update counts in
the release gate summary, and records the same path and counts under
...
reference-import, and count details, and `smoke.source` metadata for CI
...
screenshot counts plus reference-import status in the text summary, and writes
...
count, reference-import summary, and count summary, and the production smoke
source run.
