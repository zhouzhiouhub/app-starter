...
empty placeholders with disabled Commerce metadata, the public product detail
404 placeholder, and the Stripe Webhook placeholder, saves a draft, creates a
