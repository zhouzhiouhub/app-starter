...
issue list so release reviewers can spot invalid bundles quickly.
...
summary with the artifact path, issue count, and count totals. Keep using
explicit `--visual-artifact-dir reports/visual/page-builder-fixture`
