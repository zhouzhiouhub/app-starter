...
file list, retained preview screenshots, follow-up commands, and the same
terminal and Markdown `First missing reference` hint. Run
...
required source reference availability, any recorded `sourceDirStatus` value, and the
