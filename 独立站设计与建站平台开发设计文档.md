...
- Admin 登录、页面编辑、预览、发布 Smoke Test；发布链路可用 `pnpm smoke:publish` 验证 Draft Save、Preview Token、Public Preview、Web Preview、API Publish、Preview / Publish Audit Logs、Public Page、Storefront HTML 与 ISR Revalidate。
