...
- 生产部署与回滚操作以 `infra/README.md` runbook 为准；该 runbook 必须覆盖 Vercel 前台、Admin 静态托管、独立 Node API、PostgreSQL 迁移、Redis、Cloudflare R2 / CDN、Production Smoke、release handoff、release notes 和 rollback target。
