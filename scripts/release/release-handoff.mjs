...
Release handoff:
  ...
  dispatch inputs output, dispatch input table output, smoke:dispatch validation,
  gh dispatch template, and Production Smoke manual dispatch path when that evidence is missing. It
