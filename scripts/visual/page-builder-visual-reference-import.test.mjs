...
test("visual reference import command is exposed in docs", () => {
  ...
  assert.match(
    packageJson,
    /"visual:references:request": "node scripts\/page-builder-visual-reference-request\.mjs --manifest reports\/visual\/page-builder-fixture\/page-builder-visual-acceptance\.json --output artifacts\/visual\/page-builder-reference-request\.md --missing-output artifacts\/visual\/page-builder-missing-references\.txt --table-output artifacts\/visual\/page-builder-reference-export-table\.tsv --json-output artifacts\/visual\/page-builder-reference-export-manifest\.json"/,
  );
