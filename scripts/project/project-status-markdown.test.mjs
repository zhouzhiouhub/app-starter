...
test("project status CLI writes a Markdown handoff", async () => {
  ...
  try {
    ...
    assert.match(
      markdown,
      / {4}- Reference report: `pnpm visual:references -- --manifest reports\/visual\/page-builder-fixture\/page-builder-visual-acceptance\.json --output reports\/visual\/page-builder-fixture\/visual-reference-import-report\.json --markdown-output reports\/visual\/page-builder-fixture\/visual-reference-import-report\.md --require-complete`/,
    );
    assert.match(
      markdown,
    ...
    assert.match(
      markdown,
      /Refresh visual references: `pnpm visual:references -- --manifest reports\/visual\/page-builder-fixture\/page-builder-visual-acceptance\.json --output reports\/visual\/page-builder-fixture\/visual-reference-import-report\.json --markdown-output reports\/visual\/page-builder-fixture\/visual-reference-import-report\.md --require-complete`/,
    );
    assert.match(
      markdown,
