...
test("project status CLI writes a Markdown handoff", async () => {
  ...
  try {
    ...
    assert.match(
      markdown,
      / {4}- Dispatch inputs JSON output: `artifacts\/production-smoke\/production-smoke-dispatch-inputs\.json`/,
    );
    assert.match(
      markdown,
    ...
    assert.match(
      markdown,
      / {4}- Refresh requests output: `artifacts\/release\/release-evidence-request\.md, artifacts\/visual\/page-builder-reference-request\.md, artifacts\/visual\/page-builder-missing-references\.txt, artifacts\/visual\/page-builder-reference-export-table\.tsv, artifacts\/visual\/page-builder-reference-export-manifest\.json, artifacts\/production-smoke\/production-smoke-request\.md, artifacts\/production-smoke\/production-smoke-dispatch-inputs\.txt, artifacts\/production-smoke\/production-smoke-dispatch-inputs\.tsv, artifacts\/production-smoke\/production-smoke-dispatch-inputs\.json`/,
    );
    assert.match(
      markdown,
